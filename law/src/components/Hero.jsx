  ...
  return (
    <>
      ...
      <button className="btn explore"><h4 onClick={()=>{navigate("/maps")}}> Explore</h4></button> */}
        <div className="appointment" id="ap1" style={{ display: "flex"}} onClick={()=>{navigate("/assist")}}>
        <svg
    ...
    >
      ...
      >
        ...
        <div className="appointment" id="ap3" style={{ display: "flex" }} onClick={()=>{navigate("/joinus")}}>
